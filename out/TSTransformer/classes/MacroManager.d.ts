...
export declare class MacroManager {
    ...
    private callMacros;
    private customCallMacros;
    private constructorMacros;
    private propertyCallMacros;
    private customPropertyCallMacros;
    ...
    addCallMacrosFromFiles(files: ReadonlyArray<ts.SourceFile>): void;
    addPropertyMacrosFromFiles(files: ReadonlyArray<ts.SourceFile>): void;
}
